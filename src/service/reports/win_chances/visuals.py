...
from src.service.reports.win_chances.schemas import WinChancesItem, WinChancesQuery


class WinChancesChart(Chart):
    ...
    def _compute_counts(self, games_dict: dict[int, WinChancesItem]):
    ...
    def _draw_bar_group(
        ...
        for bar, val, (matched, total) in zip(  # pyright: ignore[reportUnknownVariableType]
            ...
            pos_ver = bar.get_height() + 1  # pyright: ignore[reportUnknownMemberType, reportUnknownVariableType]
